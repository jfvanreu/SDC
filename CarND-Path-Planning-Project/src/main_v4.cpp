        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            for (int i = 0; i < 50-path_size; i++) {
              ...
              //xy_coord = getXY(pos_s, 6, map_extendedwp_s, map_extendedwp_x, map_extendedwp_y);
              xy_coord = pc.convert_sd_to_xy(pos_s, 6); //goes wacko if I use d_cur;
