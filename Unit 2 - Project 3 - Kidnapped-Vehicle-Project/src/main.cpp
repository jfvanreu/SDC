...
int main() {
	...
	// Read map data
	Map map;
	if (!read_map_data("/Users/jfvanreu/git/SDC/Unit2/CarND-Kidnapped-Vehicle-Project/data/map_data.txt", map)) {
	...
	if (!read_control_data("/Users/jfvanreu/git/SDC/Unit2/CarND-Kidnapped-Vehicle-Project/data/control_data.txt", position_meas)) {
	...
	if (!read_gt_data("/Users/jfvanreu/git/SDC/Unit2/CarND-Kidnapped-Vehicle-Project/data/gt_data.txt", gt)) {
	...
	for (int i = 0; i < num_time_steps; ++i) {
		...
		ostringstream file;
		file << "/Users/jfvanreu/git/SDC/Unit2/CarND-Kidnapped-Vehicle-Project/data/observation/observations_" << setfill('0') << setw(6) << i+1 << ".txt";
